...
function data_to_svg_cro(token_id, in_text, in_amount) {
    var svgString = "";
    var tempString = "";
    var cursor_x;
    var cursor_y;
...
function data_to_img_src_cro(id, txt, paid) {
    return 'data:image/svg+xml;base64,' + window.btoa(data_to_svg_cro(id, txt, paid));
}
